# consists of what the node is splitting data and pointers to the left and right sets of that data
# unless it's a leaf, then it has the label(s) for the category the node represents
class Node
